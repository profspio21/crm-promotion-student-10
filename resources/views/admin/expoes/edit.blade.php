...
<div class="card">
    <div class="card-header">
        {{ trans('global.detail') }} {{ trans('cruds.expo.title') }} {{ App\Models\Expo::TYPE_SELECT[$type]}}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.expoes.update",  ['expo'=> $expo->id,'type' => $type] ) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="row">
                <div class="col-lg-4">
            ...
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-Expo">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <input class="form-control" type="text" name="detail[name][]" value="{{$detail->name}}">
                            </td>
                            <td>
                                <input class="form-control" type="text" name="detail[email][]" value="{{$detail->email}}">
                            </td>
                            <td>
                                <input class="form-control" type="text" name="detail[phone][]" value="{{$detail->phone}}">
                            </td>
                            <td>
                                <input class="form-control" type="text" name="detail[jurusan][]" value="{{$detail->jurusan}}">
                            </td>
                            <td>
                                <input class="form-control" type="text" name="detail[prodi][]" value="{{$detail->prodi}}">
                            </td>
                            <td>
                                <input hidden class="form-control" type="text" name="detail[id][]" value="{{$detail->id}}">
