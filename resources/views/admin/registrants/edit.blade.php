...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.registrant.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.registrants.update", ['registrant' => $registrant->id, 'status' => $registrant->status]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('nomor_daftar') ? 'is-invalid' : '' }}" type="text" name="nomor_daftar" id="nomor_daftar" value="{{ old('nomor_daftar', $registrant->nomor_daftar) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $registrant->name) }}">
                        @if($errors->has('name'))
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="tel" name="phone" id="phone" value="{{ old('phone', $registrant->phone) }}">
                        @if($errors->has('phone'))
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('tgl_lahir') ? 'is-invalid' : '' }}" type="text" name="tgl_lahir" id="tgl_lahir" value="{{ old('tgl_lahir', $registrant->tgl_lahir) }}">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status" id="status">
                            ...
                            @foreach(App\Models\Registrant::STATUS_SELECT as $key => $label)
                                <option value="{{ $key }}" {{ old('status', $registrant->status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                            @endforeach
                        </select>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('username') ? 'is-invalid' : '' }}" type="text" name="username" id="username" value="{{ old('username', $registrant->user ? $registrant->user->username : '') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $registrant->user ? $registrant->user->email : '') }}">
                        @if($errors->has('email'))
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('password') ? 'is-invalid' : '' }}" type="password" name="password" id="password" value="{{ old('password', $registrant->user ? $registrant->user->password : '') }}">
