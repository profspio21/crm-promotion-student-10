...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.informations.store",  ['type' => $type] ) }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                <label for="detail">{{ trans('cruds.information.fields.detail') }}</label>
                    <textarea id="detail" name="detail" class="form-control ">{{ old('detail', isset($information) ? $information->detail : '') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control {{ $errors->has('media_informasi') ? 'is-invalid' : '' }}" name="media_informasi" id="media_informasi">
                            ...
                            @foreach(App\Models\Information::MEDIA_SELECT as $key => $label)
                                <option value="{{ $key }}" {{ old('media_informasi', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                            @endforeach
                        </select>
            ...
            <div class="row" style="align-items: center">
                <div class="col-auto">
                    <div class="form-group">
                        <input class="form-control date {{ $errors->has('start_publish_date') ? 'is-invalid' : '' }}" type="text" name="start_publish_date" id="start_publish_date" value="{{ old('start_publish_date_dmy', '') }}">
                        </select>
                ...
                <div class="col-auto">
                    <div class="form-group">
                        <input class="form-control date {{ $errors->has('end_publish_date') ? 'is-invalid' : '' }}" type="text" name="end_publish_date" id="end_publish_date" value="{{ old('end_publish_date_dmy', '') }}">
                        </select>
                ...
                <div class="form-group row" style="justify-content: space-between">
                    ...
                    <div class="col-auto">
                        <a class="btn btn-default" href="{{ route('admin.informations.index', ['type' => $type]) }}">
                            {{ trans('global.back') }}
                        </a>
                    </div>
                </div>
