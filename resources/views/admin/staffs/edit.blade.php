            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <span class="help-block">isikan jika ingin membuat username baru</span>
                    </div>
                    <hr><hr>
                    <div class="form-group">
                        <label for="username">{{ trans('cruds.user.fields.username') }}</label>
                        <input class="form-control {{ $errors->has('username') ? 'is-invalid' : '' }}" type="text" name="username" id="username" value="{{ old('username', $staff->user ? $staff->user->username : '') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $staff->user ? $staff->user->email : '') }}">
                        @if($errors->has('email'))
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('password') ? 'is-invalid' : '' }}" type="password" name="password" id="password" value="{{ old('password', $staff->user ? $staff->user->password : '') }}">
