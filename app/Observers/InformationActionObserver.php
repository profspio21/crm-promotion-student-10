    ...
    public function updated(Information $information)
    {
        if($information->notified === 'proses') {
            ...
            foreach($users as $index => $user) {
                ...
                $data  = ['id' => $information->id, 'target' => $target, 'model_name' => 'Information', 'title' => $information->title, 'detail' => $information->detail, 'start_publish_date' => $information->start_publish_date ?? '', 'no_hp' => $no_hp[$index]];
